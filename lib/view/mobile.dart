...
class _MobileState extends State<Mobile> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _sizeAnimation = Tween<double>(begin: 50, end: 60).animate(_controller);
  }
                                ...
                                AnimatedBuilder(
                                  ...
                                  builder: (context, child) {
                                    return Text(
                                      "M.Faizan ",
                                      style: TextStyle(
                                        fontSize: _sizeAnimation.value * 0.85,
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return Text(
                        ...
                        style: TextStyle(
                          fontSize:
                              _sizeAnimation.value * 0.80, // animated size
                          fontWeight: FontWeight.w700,
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(color: Constants().black, blurRadius: 10),
                          ],
                        ),
                        child: Column(
                          children: [
